...
contract LimitOrderManager is
    ...
    function initialize(
        ...
        ERC721Upgradeable.__ERC721_init("InstaDEX Position", "IDEX-POS");
    ...
    function processLimitOrder(
        ...
        _transferTokenTo(address(IDEX), _serviceFeePaid, msg.sender);
    ...
    function addFunding(uint256 _amount) external {
        ...
        TransferHelper.safeTransferFrom(address(IDEX), msg.sender, address(this), _amount);
    ...
    function withdrawFunding(uint256 _amount) external {
        ...
        TransferHelper.safeTransfer(address(IDEX), msg.sender, _amount);
    ...
    function quoteIDEX(uint256 _weiAmount) public override returns (uint256 quote) {

        return utils.quoteIDEX(
            factory,
            address(WETH),
            address(IDEX),
            _weiAmount
